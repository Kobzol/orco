...
It combines an execution engine for running computations with a database
that stores their results and allows you to query them.
...
(the configuration). Giving a reference to the runtime will produce the desired result.
